...
/* Motor current sense amplifier output on PA3 (bidirectional, mid-rail offset).
 * Conversion to amps happens in epb.cpp (fixed gain/offset defines there). */
#define ANA_IN_LIST \
   ANA_IN_ENTRY(current, GPIOA, 3) \
